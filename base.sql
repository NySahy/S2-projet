...
insert into objet values ("piston",3,2);
insert into objet values ("lampe",1,2);
insert into objet values ("pompe",3,2);
insert into objet values ("four",4,2);
insert into objet values ("scie",2,2);
insert into objet values ("statue",1,2);
insert into objet values ("courroie",3,2);
insert into objet values ("passoire",4,2);

insert into objet values ("tableau",1,3);
insert into objet values ("batteur",4,3);
insert into objet values ("cric",3,3);
insert into objet values ("vase",1,3);
insert into objet values ("roulement",3,3);
insert into objet values ("grille",4,3);
insert into objet values ("ponceuse",2,3);
insert into objet values ("horloge",1,3);
insert into objet values ("cle",3,3);
insert into objet values ("planche",4,3);

insert into objet values ("rideaux",1,4);
insert into objet values ("friteuse",4,4);
insert into objet values ("jauge",3,4);
insert into objet values ("guirlande",1,4);
insert into objet values ("filtre",3,4);
insert into objet values ("moule",4,4);
insert into objet values ("agrafeuse",2,4);
insert into objet values ("paravent",1,4);
insert into objet values ("allumage",3,4);
insert into objet values ("cocotte",4,4);